...
private:
	...
	std::string					mConfieFileText = \
        ...
        "log4cplus.appender.ALL_MSGS.File=logs/cmf.log\n"
        ...
        "log4cplus.appender.WARN_MSGS.File=logs/cmf.warn\n"
        ...
        "log4cplus.appender.ERROR_MSGS.File=logs/cmf.error\n"
        ...
        "log4cplus.appender.FATAL_MSGS.File=logs/cmf.fatal\n"
